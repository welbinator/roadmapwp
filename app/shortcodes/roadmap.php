            ...
            <div class="roadmap-column">
                ...
                if ( $query->have_posts() ) {
                    while ( $query->have_posts() ) :
                        ...
                        ?>
                        <div class="wp-roadmap-idea border bg-card text-card-foreground rounded-lg shadow-lg overflow-hidden m-2 <?php echo esc_attr( apply_filters('roadmapwp_roadmap_shortcode_idea_classes', '', $idea_id) ); ?>">
                            <div class="p-6">
                                ...
                                <?php
                                    ...
                                    // Add the do_action here for the pro-specific content
                                    
                                ?>
                            </div>
							<?php do_action('roadmapwp_roadmap_shortcode_after_idea_content', $idea_id, $vote_count); ?>
                        </div>
                        <?php
                    endwhile;
                } else {
